...
class ContentPreview:
    ...
    def _preview_code(self, file_path: Union[str, Path], 
        ...
        try:
            ...
            # 生成语法高亮HTML
            html = self._generate_syntax_highlight_html(
                content, 
    ...
    def _generate_text_preview_html(self, content: str, 
        ...
        <div class="text-preview">
            ...
            <div class="text-content">
                <pre class="text-content">{numbered_content}</pre>
            </div>
        </div>
        """
    ...
    def _generate_image_preview_html(self, file_path: Union[str, Path], 
        ...
        <div class="image-preview">
            ...
            <div class="image-content">
                <img src="data:{mime_type};base64,{base64_data}" alt="{filename}" class="preview-image">
            </div>
