...
if ($BackupCurrent) {
    ...
    Write-Host "  .\setup_environment.ps1 -SetEnvironment     # 设置LAD环境变量" -ForegroundColor Gray
    Write-Host "  .\setup_environment.ps1 -RemoveEnvironment  # 移除LAD环境变量" -ForegroundColor Gray
    Write-Host "  .\setup_environment.ps1 -TestEnvironment    # 测试环境变量配置" -ForegroundColor Gray
    Write-Host "  .\setup_environment.ps1 -BackupCurrent      # 备份当前环境变量" -ForegroundColor Gray
    Write-Host ""
