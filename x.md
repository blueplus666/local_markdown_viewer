...
│   ├── main_window.py              # 主窗口类
│   ├── file_tree.py                # 文件树组件
│   ├── content_viewer.py           # 内容显示组件
│   └── styles/
│       ├── main.qss                # 主样式表
│       └── themes/                 # 主题样式
├── core/
│   ├── file_resolver.py            # 文件解析模块
│   ├── markdown_renderer.py        # Markdown渲染器
│   └── content_preview.py          # 内容预览器
├── utils/
...
├── FileResolver.resolve_file()
│   ├── analyze_file_type()
│   └── resolve_relative_path()
├── ContentViewer.display_content()
│   ├── MarkdownRenderer.render() (如果是Markdown)
│   └── ContentPreview.preview() (如果是其他文件)
│
